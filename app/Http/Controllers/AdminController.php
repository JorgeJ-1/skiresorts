...
class AdminController extends Controller
{
    ...
    public function deletedSkiResorts(){
        
        // para hacer el join de las estaciones de esquí con el usuario se tiene que 
        // hacer una select join en query builder
        
        $skiResorts= SkiResort::onlyTrashed()->paginate(config('pagination.skiResorts', 10));
        
        return view('admin.skiResorts.deleted', ['skiResorts' => $skiResorts]);
    }
